...
public class bank_option1_presentation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bank_option1_presentation);
        ...
        forward.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(getApplicationContext(), ColeAccount.class);
                startActivity(intent);
            }
        });
    }
